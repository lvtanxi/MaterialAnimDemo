...
package com.lv.materialanimdemo.view;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        float textSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,14,getContext().getResources().getDisplayMetrics());
        ...
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, textSize);
        ...
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize,textSize);

        grarity = typedArray.getInt(R.styleable.ExpandableTextView_collapseExpandGrarity, Gravity.LEFT);
        message = typedArray.getString(R.styleable.ExpandableTextView_textMessage);
